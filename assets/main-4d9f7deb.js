import{i as H,a as w,P as me,b as fe,g as be,c as ye,u as ve,s as Le,o as j,d as ke,e as Se,r as Y,f as we,S as Ae,h as J}from"./vendor-dc6e18bd.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}})();const G=document.querySelector(".toggle-checkbox");document.addEventListener("DOMContentLoaded",()=>{localStorage.getItem("theme")==="theme-dark"&&(q("theme-dark"),G.checked=!0)});function q(e){localStorage.setItem("theme",e),document.documentElement.setAttribute("data-theme",e)}G.addEventListener("click",()=>{localStorage.getItem("theme")==="theme-dark"?q("theme-light"):q("theme-dark")});const T=document.querySelector(".scroll-up");window.addEventListener("scroll",()=>{window.scrollY>120?T.classList.add("show"):T.classList.remove("show")});T.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const c={body:document.querySelector("body"),burger:document.querySelector(".header-btn-burgher"),headerNav:document.querySelector(".header-menu"),headerLink:document.querySelectorAll(".header-nav-item-modal"),home:document.querySelector(".header-home"),shopping:document.querySelector(".header-shopping"),homeMobal:document.querySelector(".header-home-modal"),shoppingMobal:document.querySelector(".header-shopping-modal")};function Ce(){c.burger.classList.toggle("active"),c.headerNav.classList.toggle("active"),c.body.classList.toggle("lock")}c.burger.addEventListener("click",Ce);window.addEventListener("DOMContentLoaded",()=>{c.home.classList.add("active"),c.homeMobal.classList.add("active")});window.location.href.includes("index.html")?window.addEventListener("DOMContentLoaded",()=>{c.home.classList.add("active"),c.shopping.classList.remove("active"),c.homeMobal.classList.add("active"),c.shoppingMobal.classList.remove("active")}):window.location.href.includes("shopping.html")&&window.addEventListener("DOMContentLoaded",()=>{c.home.classList.remove("active"),c.shopping.classList.add("active"),c.homeMobal.classList.remove("active"),c.shoppingMobal.classList.add("active")});const h="/project-Pronto11/assets/icons-f2d3a100.svg",l={body:document.querySelector("body"),authen:document.querySelector(".authentication"),authenClose:document.querySelector(".authentication-close"),headerSubmitCont:document.querySelector(".authentication-buttons"),headerSubmitContMob:document.querySelector(".authentication-buttons-mob"),headerSubmit:document.querySelector(".header-btn-submit"),headerSubmitModal:document.querySelector(".header-btn-submit-modal"),signUpLink:document.querySelector(".authentication-signup"),signInLink:document.querySelector(".authentication-signin")};function v(e){l.authen.classList.toggle("is-active",e),l.body.classList.toggle("authentication-open",e)}function Ee(){document.querySelector(".authentication-form-signup").classList.remove("hide"),l.signUpLink.classList.add("active"),document.querySelector(".authentication-form-signin").classList.add("hide"),l.signInLink.classList.remove("active")}function Ie(){document.querySelector(".authentication-form-signin").classList.remove("hide"),l.signInLink.classList.add("active"),document.querySelector(".authentication-form-signup").classList.add("hide"),l.signUpLink.classList.remove("active")}l.authen&&(l.headerSubmitCont.addEventListener("click",e=>{e.target.classList.contains("header-btn-submit")&&v(!0)}),l.headerSubmitContMob.addEventListener("click",e=>{e.target.classList.contains("header-btn-submit")&&v(!0)}),l.authenClose.addEventListener("click",()=>{v(!1)}),l.signUpLink.classList.add("active"),l.signUpLink.addEventListener("click",()=>{Ee()}),l.signInLink.addEventListener("click",()=>{Ie()}));const V=(e,t)=>!e||e.length===0?`<div class="books-container"><h2 class="books-title">Best Sellers Books</h2>
  ...
  <a href="#" data-catname="" class="categories-nav active">All categories</a>
    ...
    </li>`).join("")}`;function z(){return H.error({message:"Sorry, no books found.",position:"topRight",icon:null}),`</div>
  ...
  <span>Nothing found</span>
  ...
  </button>`;t.innerHTML=s,o.innerHTML=s}}re();function ce(e){e.classList.add("disable")}function le(e){e.classList.remove("disable")}function de(e,t){let o="An unknown error has occurred. Please try again.";const s=e.querySelector(".authentication-errorcont");t==="auth/email-already-in-use"&&(o="A user with this email address already exists."),t==="auth/invalid-credential"&&(o="Incorrect login or password"),t==="auth/weak-password"&&(o="Your password is too weak"),s.innerHTML=`<p class="auth-error">${o}</p>`}function ue(e){const t=e.querySelector(".authentication-errorcont");t.innerHTML=""}function P(e){H.success({message:`${e} is successful`,position:"bottomRight",icon:null})}function $e(e){H.error({message:e,position:"bottomRight",icon:null})}const pe=ke();function _e(e,t){Se(Y(pe,"users/"+e),{shippinglist:t})}async function et(e){const t=Y(pe,"users/"+e+"/shippinglist");try{const o=await we(t);return o.exists()?o.val():null}catch(o){return console.error("Error getting data:",o),null}}async function O(e){e||(e=localStorage.getItem("shoppinglist")||""),ge(e);const t=await ae().then(o=>o).catch(o=>"");if(!t)localStorage.setItem("shoppinglist",e);else{const o=t.uid;e&&_e(o,e)}}const b=async()=>{const e=await ae().then(t=>t).catch(t=>"");if(e){const t=e.uid;return et(t)}else return localStorage.getItem("shoppinglist")};async function ge(e){e||(e=await b().then(n=>n).catch(n=>""));const t=JSON.parse(e).length,o=document.querySelector(".header-shopping span"),s=document.querySelector(".header-shopping-modal span");t>0?(o.innerHTML=`<span>${t}</span>`,s.innerHTML=`<span>${t}</span>`):(o.innerHTML="",s.innerHTML="")}const u=new Ae(".swiper",{direction:"vertical",loop:!1,initialSlide:0,speed:500,slidesPerView:6,effect:"slide",rewind:!0,breakpoints:{292:{slidesPerView:6}},spaceBetween:20,keyboard:{enabled:!0,onlyInViewport:!0},shortSwipes:!1,preventClicks:!0,disableMouseEvents:!0});u.allowTouchMove=!1;u.on("slideChange",function(){u.isEnd?u.allowTouchMove=!1:u.allowTouchMove=!0});const M=document.querySelector(".swiper-button");M.addEventListener("click",function(){u.activeIndex===2?M.classList.add("rotate"):M.classList.remove("rotate"),u.activeIndex<u.slides.length-1?u.slideNext():u.slideTo(0)});async function tt(){const e=document.querySelector(".books-container");e&&e.addEventListener("click",t);async function t(o){if(o.target.classList.contains("books-overlay")){const s=o.target.dataset.id,n=await $(s);ot(n)}}}async function ot(e){const t=document.querySelector(".popup-backdrop"),o=document.querySelector(".popup-window");o.innerHTML="";const s=it(e);o.insertAdjacentHTML("beforeend",s);const n=document.querySelector(".popup-close-btn");i(),st(),await at(),t.addEventListener("click",k),document.addEventListener("keydown",R),n.addEventListener("click",f),document.addEventListener("keydown",a);function a(g){g.keyCode===32&&g.preventDefault()}function i(){t.classList.add("is-active"),document.body.classList.add("modal-open")}function f(){C(),n.removeEventListener("click",f),document.removeEventListener("keydown",a)}function k(g){g.target===g.currentTarget&&(C(),t.removeEventListener("click",k),document.removeEventListener("keydown",a))}function R(g){g.keyCode===27&&(C(),document.removeEventListener("keydown",R),document.removeEventListener("keydown",a))}function C(){t.classList.remove("is-active"),document.body.classList.remove("modal-open")}}async function st(){const e=document.querySelector(".popup-book-btn-add-to-shopinglist"),t=e.dataset.id,o=await b();(JSON.parse(o)||[]).map(a=>a._id).includes(t)?(e.textContent="REMOVE FROM THE SHOPPING LIST",e.insertAdjacentHTML("afterend",he())):e.textContent="ADD TO SHOPPING LIST"}async function nt(e){const t=await b(),o=JSON.parse(t)||[];o.push(e),await O(JSON.stringify(o))}async function at(){const e=document.querySelector(".popup-book-btn-add-to-shopinglist"),t=e.dataset.id,o=await $(t);e.addEventListener("click",s);async function s(){const n=await b();(JSON.parse(n)||[]).map(f=>f._id).includes(t)?(await _(t),document.querySelector(".under-btn-text").remove(),e.textContent="ADD TO SHOPPING LIST"):(nt(o),e.textContent="REMOVE FROM THE SHOPPING LIST",e.insertAdjacentHTML("afterend",he()))}}function it(e){const{_id:t,author:o,title:s,book_image:n,buy_links:a,description:i=""}=e,[f,k]=a;return`<button class="popup-close-btn">
    ...
    `}const m=document.querySelector(".books-container"),y=document.querySelector(".categories-menu");let K;async function B(){F();const e=window.innerWidth,t=U(e),o=await qe(t);m.innerHTML=o,K||(tt(),K=!0),N()}async function rt(){const e=await Te();y.innerHTML=e}async function x(e){F();const t=await Be(e);m.innerHTML=t,N()}async function N(){const e=document.querySelector(".books-title"),t=e.textContent.split(" "),o=t.pop(),s=t.join(" ")+(t.length>0?` <span  class="books-title-color">${o}</span>`:o);e.innerHTML=s}function U(e){let t=5;return e>=1440&&(t=5),e>=768&&e<1440&&(t=3),e<768&&(t=1),t}const ct=window.innerWidth;let Z=U(ct);async function lt(){const e=document.querySelector(".categories-nav.active");if(e&&!e.dataset.catname){const o=window.innerWidth,s=U(o);Z!==s&&(Z=s,F(),await B(),N())}}m&&(B(),rt(),y.addEventListener("click",e=>{e.preventDefault();const t=e.target;if(t.tagName==="A"){const o=t.dataset.catname;y.querySelector(".active").classList.remove("active"),t.classList.add("active"),J(m,{offset:-24,duration:500}),o?x(o):B()}}),m.addEventListener("click",e=>{e.preventDefault();const t=e.target;if(t.classList.contains("books-btn")){const o=t.dataset.catname;y.querySelector(".active").classList.remove("active"),y.querySelector('[data-catname="'+o+'"]').classList.add("active"),J(m,{offset:-24,duration:700}).on("end",()=>{x(o)})}}),window.addEventListener("resize",lt));function F(){m.innerHTML='<li class="loader-container"><span class="loader"></span></li>'}
//# sourceMappingURL=main-4d9f7deb.js.map
