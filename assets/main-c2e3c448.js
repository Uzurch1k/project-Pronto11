import{a as l}from"./vendor-0cb09735.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&c(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const p=e=>`<div class="books-container"><h2 class="books-title">Best Sellers Books</h2>${e.map(t=>{const c=t.list_name,o=u(t.books);return`<div class="books-category-container">
  ...
  <li class="categories-list">
    <a href="#" data-catname="Advice How-To and Miscellaneous" class="categories-nav">Advice, how-to & Miscellaneous</a>
  </li>`,k=(e,a)=>{const t=u(e);return`<div class="books-container">
    <h2 class="books-title">${a}</h2>
    <div class="books-category-container">
      <ul class="books-list">${t}</ul>
    </div>
  </div>`};function u(e){return e.map(t=>{const c=t._id,o=t.book_image,s=t.title,n=t.author;return`<li class="books-item">
      ...
      </li>`}).join("")}const d="https://books-backend.p.goit.global",y=async()=>{const a=d+"/books/top-books/";try{const t=await l.get(a);return p(t.data)}catch(t){console.log(t)}},w=async()=>{const a=d+"/books/category-list/";try{const t=await l.get(a);return b(t.data)}catch(t){console.log(t)}},H=async e=>{const t=d+"/books/category/",c={category:e};try{const o=await l.get(t,{params:c});return k(o.data,e)}catch(o){console.log(o)}},g=document.querySelector(".books-container"),i=document.querySelector(".categories-menu");async function m(){const e=await y();g.innerHTML=e,v()}m();async function T(){const e=await w();i.innerHTML=e}T();i.addEventListener("click",e=>{e.preventDefault();const a=e.target;if(a.tagName==="A"){const t=a.dataset.catname;i.querySelector(".active").classList.remove("active"),a.classList.add("active"),t?f(t):m()}});g.addEventListener("click",e=>{e.preventDefault();const a=e.target;if(a.classList.contains("books-btn")){const t=a.dataset.catname;i.querySelector(".active").classList.remove("active"),i.querySelector('[data-catname="'+t+'"]').classList.add("active"),f(t)}});async function f(e){const a=await H(e);g.innerHTML=a,v()}function v(){const e=document.querySelector(".books-title"),a=e.textContent.split(" "),t=a.pop(),c=a.join(" ")+(a.length>0?` <span>${t}</span>`:t);e.innerHTML=c}const h=document.querySelector(".toggle-checkbox");document.addEventListener("DOMContentLoaded",()=>{localStorage.getItem("theme")==="theme-dark"&&(r("theme-dark"),h.checked=!0)});function r(e){localStorage.setItem("theme",e),document.documentElement.setAttribute("data-theme",e)}h.addEventListener("click",()=>{localStorage.getItem("theme")==="theme-dark"?r("theme-light"):r("theme-dark")});
//# sourceMappingURL=main-c2e3c448.js.map
