import{S as N,a as g,s as E,P as H}from"./vendor-7a68f705.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}})();const O=document.querySelector(".toggle-checkbox");document.addEventListener("DOMContentLoaded",()=>{localStorage.getItem("theme")==="theme-dark"&&(f("theme-dark"),O.checked=!0)});function f(e){localStorage.setItem("theme",e),document.documentElement.setAttribute("data-theme",e)}O.addEventListener("click",()=>{localStorage.getItem("theme")==="theme-dark"?f("theme-light"):f("theme-dark")});const k=document.querySelector(".scroll-up");window.addEventListener("scroll",()=>{window.scrollY>120?k.classList.add("show"):k.classList.remove("show")});k.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const i={body:document.querySelector("body"),burger:document.querySelector(".header-btn-burgher"),headerNav:document.querySelector(".header-menu"),headerLink:document.querySelectorAll(".header-nav-item-modal"),logo:document.querySelector(".header-logo"),home:document.querySelector(".header-home"),shopping:document.querySelector(".header-shopping"),homeMobal:document.querySelector(".header-home-modal"),shoppingMobal:document.querySelector(".header-shopping-modal")};function A(){i.burger.classList.toggle("active"),i.headerNav.classList.toggle("active"),i.body.classList.toggle("lock")}i.burger.addEventListener("click",A);function y(){localStorage.setItem("isActive","home")}i.logo.addEventListener("click",y);i.home.addEventListener("click",y);i.homeMobal.addEventListener("click",y);function q(){localStorage.setItem("isActive","shopping")}i.shopping.addEventListener("click",q);i.shoppingMobal.addEventListener("click",q);window.addEventListener("DOMContentLoaded",()=>{const e=localStorage.getItem("isActive");i.home.classList.add("active"),i.homeMobal.classList.add("active"),e==="home"?(i.home.classList.add("active"),i.shopping.classList.remove("active"),i.homeMobal.classList.add("active"),i.shoppingMobal.classList.remove("active")):e==="shopping"&&(i.home.classList.remove("active"),i.shopping.classList.add("active"),i.homeMobal.classList.remove("active"),i.shoppingMobal.classList.add("active"))});const d=new N(".swiper",{direction:"vertical",loop:!1,initialSlide:0,speed:500,slidesPerView:6,effect:"slide",rewind:!0,breakpoints:{292:{slidesPerView:6}},spaceBetween:20,keyboard:{enabled:!0,onlyInViewport:!0}});d.allowTouchMove=!1;const h=document.querySelector(".swiper-button");h.addEventListener("click",function(){d.activeIndex===2?h.classList.add("rotate"):h.classList.remove("rotate"),d.activeIndex<d.slides.length-1?d.slideNext():d.slideTo(0)});const I=(e,t)=>`<div class="books-container"><h2 class="books-title">Best Sellers Books</h2>${e.map(s=>{const n=s.list_name,a=B(s.books.slice(0,t));return`<div class="books-category-container">
      ...
      </div>`}).join("")}</div>`,D=e=>`<li class="categories-list">
  <a href="#" data-catname="" class="categories-nav active">All categories</a>
    ...
    </li>`).join("")}`,x=(e,t)=>{const o=B(e);return`<div class="books-container">
    <h2 class="books-title">${t}</h2>
    <div class="books-category-container">
      <ul class="books-list">${o}</ul>
    </div>
  </div>`};function B(e){return e.map(o=>{const{_id:s,book_image:n,title:a,author:c}=o;return`<li class="books-item">
      ...
      </li>`}).join("")}const m="https://books-backend.p.goit.global";let b=JSON.parse(sessionStorage.getItem("savedfetch"))||"";const _=async e=>{if(b)return I(b,e);{const o=m+"/books/top-books/";try{const s=await g.get(o);return sessionStorage.setItem("savedfetch",JSON.stringify(s.data)),b=s.data,I(s.data,e)}catch(s){console.log(s)}}},R=async()=>{const t=m+"/books/category-list/";try{const o=await g.get(t);return D(o.data)}catch(o){console.log(o)}},F=async e=>{const o=m+"/books/category/",s={category:e};try{const n=await g.get(o,{params:s});return x(n.data,e)}catch(n){console.log(n)}},P=async e=>{const t=`/books/${e}`,o=m+t;try{return(await g.get(o)).data}catch(s){console.log(s)}},l=document.querySelector(".books-container"),u=document.querySelector(".categories-menu");async function v(){w();const e=window.innerWidth,t=S(e),o=await _(t);l.innerHTML=o,L()}async function J(){const e=await R();u.innerHTML=e}async function T(e){w();const t=await F(e);l.innerHTML=t,L()}async function L(){const e=document.querySelector(".books-title"),t=e.textContent.split(" "),o=t.pop(),s=t.join(" ")+(t.length>0?` <span  class="books-title-color">${o}</span>`:o);e.innerHTML=s}function S(e){let t=5;return e>=1440&&(t=5),e>=768&&e<1440&&(t=3),e<768&&(t=1),t}const j=window.innerWidth;let C=S(j);async function V(){if(!document.querySelector(".categories-nav.active").dataset.catname){const t=window.innerWidth,o=S(t);C!==o&&(C=o,w(),await v(),L())}}l&&(v(),J(),u.addEventListener("click",e=>{e.preventDefault();const t=e.target;if(t.tagName==="A"){const o=t.dataset.catname;u.querySelector(".active").classList.remove("active"),t.classList.add("active"),E(l,{offset:-24,duration:500}),o?T(o):v()}}),l.addEventListener("click",e=>{e.preventDefault();const t=e.target;if(t.classList.contains("books-btn")){const o=t.dataset.catname;u.querySelector(".active").classList.remove("active"),u.querySelector('[data-catname="'+o+'"]').classList.add("active"),E(l,{offset:-24,duration:700}).on("end",()=>{T(o)})}}),window.addEventListener("resize",V));function w(){l.innerHTML='<li class="loader-container"><span class="loader"></span></li>'}const M=document.querySelector("#pagination-wrapper");function W(){return matchMedia("(min-width: 768px)").matches?3:2}const U=W(),G={totalItems:10,itemsPerPage:3,visiblePages:U,centerAlign:!1,template:{page:'<a href="#" class="tui-page-btn"><span class="number-text">{{page}}</span></a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}} custom-class-{{type}}"><span class="tui-ico-{{type}}"></span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}} custom-class-{{type}}"><span class="tui-ico-{{type}}"></span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip custom-class-{{type}}"><span class="tui-ico-ellip">...</span></a>'}};function z(){M!==null&&new H(M,G)}z();const K=async e=>{try{const t=await P(e);let o=JSON.parse(localStorage.getItem("shoppinglist"))||[];o.push(t),localStorage.setItem("shoppinglist",JSON.stringify(o))}catch(t){console.error(t)}},Y=async e=>{const o=(JSON.parse(localStorage.getItem("shoppinglist"))||[]).filter(s=>s._id!==e);localStorage.setItem("shoppinglist",JSON.stringify(o))};setTimeout(()=>{Q()},3e3);async function Q(){const e=document.querySelector(".books-container");e&&e.addEventListener("click",t);async function t(o){const s=document.querySelector(".popup-window");if(s.innerHTML="",o.target.classList.contains("books-overlay")){const n=o.target.dataset.id,a=await P(n),c=Z(a);s.insertAdjacentHTML("beforeend",c),X()}}}async function X(){const e=document.querySelector(".popup-backdrop"),t=document.querySelector(".popup-close-btn");s(),ee(),te(),e.addEventListener("click",a),document.addEventListener("keydown",c),t.addEventListener("click",n),document.addEventListener("keydown",o);function o(r){r.keyCode===32&&r.preventDefault()}function s(){e.classList.add("is-active")}function n(){p(),t.removeEventListener("click",n),document.removeEventListener("keydown",o)}function a(r){r.target===r.currentTarget&&(p(),e.removeEventListener("click",a),document.removeEventListener("keydown",o))}function c(r){r.keyCode===27&&(p(),document.removeEventListener("keydown",c),document.removeEventListener("keydown",o))}function p(){e.classList.remove("is-active")}}function Z(e){const{_id:t,author:o,title:s,book_image:n,buy_links:a,description:c=""}=e,[p,r]=a;return`<button class="popup-close-btn">
