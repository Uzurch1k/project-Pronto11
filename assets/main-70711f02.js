import{S as C,a as p}from"./vendor-93e8fa5a.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();new C(".swiper",{direction:"vertical",loop:!1,speed:100,slidesPerView:6,keyboard:{enabled:!0,onlyInViewport:!0},mousewheel:{invert:!0},shortSwipes:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});const c={body:document.querySelector("body"),burger:document.querySelector(".header-btn-burgher"),headerNav:document.querySelector(".header-menu"),headerLink:document.querySelectorAll(".header-nav-item-modal"),logo:document.querySelector(".header-logo"),home:document.querySelector(".header-home"),shopping:document.querySelector(".header-shopping"),homeMobal:document.querySelector(".header-home-modal"),shoppingMobal:document.querySelector(".header-shopping-modal")};function E(){c.burger.classList.toggle("active"),c.headerNav.classList.toggle("active"),c.body.classList.toggle("lock")}c.burger.addEventListener("click",E);function g(){localStorage.setItem("isActive","home")}c.logo.addEventListener("click",g);c.home.addEventListener("click",g);c.homeMobal.addEventListener("click",g);function y(){localStorage.setItem("isActive","shopping")}c.shopping.addEventListener("click",y);c.shoppingMobal.addEventListener("click",y);window.addEventListener("DOMContentLoaded",()=>{const e=localStorage.getItem("isActive");c.home.classList.add("active"),c.homeMobal.classList.add("active"),e==="home"?(c.home.classList.add("active"),c.shopping.classList.remove("active"),c.homeMobal.classList.add("active"),c.shoppingMobal.classList.remove("active")):e==="shopping"&&(c.home.classList.remove("active"),c.shopping.classList.add("active"),c.homeMobal.classList.remove("active"),c.shoppingMobal.classList.add("active"))});const q=(e,o)=>`<div class="books-container"><h2 class="books-title">Best Sellers Books</h2>${e.map(n=>{const s=n.list_name,a=L(n.books.slice(0,o));return`<div class="books-category-container">
      ...
      </div>`}).join("")}</div>`,M=e=>`<li class="categories-list">
  <a href="#" data-catname="" class="categories-nav active">All categories</a>
    ...
    </li>`).join("")}`,$=(e,o)=>{const t=L(e);return`<div class="books-container">
    ...
    <div class="books-category-container">
      ...
      </li>`}).join("")}const u="https://books-backend.p.goit.global",w=async e=>{const t=u+"/books/top-books/";try{const n=await p.get(t);return q(n.data,e)}catch(n){console.log(n)}},T=async()=>{const o=u+"/books/category-list/";try{const t=await p.get(o);return M(t.data)}catch(t){console.log(t)}},B=async e=>{const t=u+"/books/category/",n={category:e};try{const s=await p.get(t,{params:n});return $(s.data,e)}catch(s){console.log(s)}},I=async e=>{const o=`/books/${e}`,t=u+o;try{return(await p.get(t)).data}catch(n){console.log(n)}},d=document.querySelector(".books-container"),l=document.querySelector(".categories-menu");async function b(){const e=window.innerWidth,o=k(e),t=await w(o);d.innerHTML=t,h()}async function A(){const e=await T();l.innerHTML=e}async function f(e){const o=await B(e);d.innerHTML=o,h()}function h(){const e=document.querySelector(".books-title"),o=e.textContent.split(" "),t=o.pop(),n=o.join(" ")+(o.length>0?` <span  class="books-title-color">${t}</span>`:t);e.innerHTML=n}function k(e){let o=3;return e>=1440&&(o=5),e<768&&(o=1),o}const H=window.innerWidth;let v=k(H);async function O(){if(!document.querySelector(".categories-nav.active").dataset.catname){const o=window.innerWidth,t=k(o);if(v!==t){v=t;const n=await w(t);d.innerHTML=n,h()}}}d&&(b(),A(),l.addEventListener("click",e=>{e.preventDefault();const o=e.target;if(o.tagName==="A"){const t=o.dataset.catname;l.querySelector(".active").classList.remove("active"),o.classList.add("active"),t?f(t):b()}}),d.addEventListener("click",e=>{e.preventDefault();const o=e.target;if(o.classList.contains("books-btn")){const t=o.dataset.catname;l.querySelector(".active").classList.remove("active"),l.querySelector('[data-catname="'+t+'"]').classList.add("active"),f(t)}}),window.addEventListener("resize",O));setTimeout(()=>{W()},3e3);async function W(){document.querySelector(".books-container").addEventListener("click",o);async function o(t){const n=document.querySelector(".popup-book");if(n.innerHTML="",t.target===t.target.closest(".books-overlay")){const s=t.target.dataset.id,a=await I(s),i=N(a);n.insertAdjacentHTML("beforeend",i),P()}}}async function P(){const e=document.querySelector(".popup-backdrop"),o=document.querySelector(".popup-close-btn");t(),e.addEventListener("click",s),document.addEventListener("keydown",a),o.addEventListener("click",n);function t(){e.classList.add("is-active")}function n(){i(),o.removeEventListener("click",n)}function s(r){r.target===r.currentTarget&&(i(),e.removeEventListener("click",s))}function a(r){r.keyCode===27&&(i(),document.removeEventListener("keydown",a))}function i(){e.classList.remove("is-active")}}function N(e){const{author:o,title:t,book_image:n,buy_links:s,description:a=""}=e,[i,r]=s;return`
